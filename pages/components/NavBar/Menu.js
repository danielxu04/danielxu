...
function Menu(props){
    return (
        <div className={`flex bg-transparent h-screen top-0 flex-col absolute z-30 pt-72 text-right left-0 w-screen transition ${props.click ? 'translate-x-0' : 'translate-x-full'}`}>
